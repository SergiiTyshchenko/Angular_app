...
App.factory('RequestService', ['$http', '$q', function($http, $q){
    ...
    return {
        ...
        fetchAllRequests: function() {
            return $http.get('http://localhost:8010/AreaDTool/request/')
                .then(
                    function(response){
        ...
        createRequest: function(request){
            ...
            return $http.post('http://localhost:8010/AreaDTool/request/', request)
                .then(
                    function(response){
                        return response.data;
                    },
        ...
        updateRequest: function(request, id){
            return $http.put('http://localhost:8010/AreaDTool/request/'+id, request)
                .then(
                    function(response){
                        return response.data;
                    },
        ...
        deleteRequest: function(id){
            return $http.delete('http://localhost:8010/AreaDTool/request/'+id)
                .then(
                    function(response){
                        return response.data;
                    },
